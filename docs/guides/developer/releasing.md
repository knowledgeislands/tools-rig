...
1. Complete the repository [definition of done](definition-of-done.md), then confirm the intended version is represented in `bin/rig`, `CHANGELOG.md`, the manual, completion output, and README.
